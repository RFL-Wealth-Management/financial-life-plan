...
export const mockIflpFormState: IflpFormState = {
  ...
  // A realistic mix: both clients hold a TFSA and a Corporate Fixed contribution,
  // only client 1 has an RRSP and a PPP, FHSA and Non-Registered are present so
  // the new sections exercise, and the corporation holds one liquid bucket.
  accounts: [
    { kind: "tfsa", party: "client1", monthlyContribution: 583, estimatedValue: 210000, retirementIncome: null },
    { kind: "tfsa", party: "client2", monthlyContribution: 583, estimatedValue: 185000, retirementIncome: null },
    { kind: "rrsp", party: "client1", monthlyContribution: 2630, estimatedValue: 640000, retirementIncome: null },
    { kind: "fhsa", party: "client2", monthlyContribution: 667, estimatedValue: 40000, retirementIncome: null },
    { kind: "non_registered", party: "client1", monthlyContribution: 1000, estimatedValue: 150000, retirementIncome: null },
    { kind: "ppp", party: "client1", monthlyContribution: 3500, estimatedValue: 890000, retirementIncome: null },
    { kind: "corporate_liquid", party: "corporation", monthlyContribution: 1500, estimatedValue: 720000, retirementIncome: 60000 },
    { kind: "corporate_fixed", party: "client1", monthlyContribution: 4167, estimatedValue: null, retirementIncome: null },
    { kind: "corporate_fixed", party: "client2", monthlyContribution: 2500, estimatedValue: null, retirementIncome: null },
  ],
  corporateAccounts: {
